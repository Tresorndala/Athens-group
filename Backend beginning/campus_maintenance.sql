...
-- Note: reportID will be generated by the PHP code now
INSERT INTO `report` (`reportID`, `userID`, `maintenanceTypeID`, `statusID`, `description`, `location`) VALUES 
    ('report_605bcf5d418e1', 1, 1, 1, 'Flickering lights in the main hallway', 'Main Hallway'), -- John Doe (Admin)
    ('report_605bcf5d418e2', 2, 2, 2, 'Leaking pipe in the restroom', 'Restroom'); -- Jane Smith (Regular)
